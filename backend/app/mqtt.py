...
class MQTT:
    ...
    sub_topics = [("620165845_pub", 0), ("620165845", 0), ("620165845_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620165845", self.update)
        self.client.message_callback_add("620165845_pub", self.toggle)
